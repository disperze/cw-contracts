...
This is a basic implementation of a cw721 NFT contract. It is designed to
...
The `ExecuteMsg` and `QueryMsg` implementations follow the [CW721 spec](https://github.com/CosmWasm/cw-plus/blob/main/packages/cw721/README.md) and are described there.
